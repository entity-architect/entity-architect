...
[CRUD.Feature.Route(nameof(Author), "say-hi1"), Secured(typeof(Client))]
public record TestCustomEndpointCommand(Guid AuthorId = default!) : ICommand<string>, IPost;
public class TestCustomEndpointCommandHandler(IRepository<Author> authorRepository, IClaimProvider claimProvider) : ICommandHandler<TestCustomEndpointCommand, string>
{
